...
- `src-tauri/` — Rust core: `catalog/` (SQLite catalog, [ADR-0005](../docs/adr/ADR-0005-catalog-storage.md)), `develop_engine/` (CPU edit-stack reference renderer), `raw_decode.rs` (LibRaw via `rsraw`, [ADR-0003](../docs/adr/ADR-0003-raw-decoding.md)), `import.rs` (import pipeline), `lib.rs` (Tauri commands).
