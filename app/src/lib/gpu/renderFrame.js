...
export function writeAdjustmentsAndRender(/** @type {import('./gpuHandles.js').GpuHandles} */ gpu, /** @type {import('./gpuHandles.js').RenderInputs} */ inputs) {
  ...
  if (spatialOpsKey !== gpu.spatialOpsInputsKey) {
    ...
    runFullscreenPass(encoder, gpu.meanHPipeline, gpu.meanHBindGroup, gpu.transmissionHTex.createView());
    runFullscreenPass(encoder, gpu.meanVPipeline, gpu.meanVBindGroup, gpu.transmissionTex.createView());
  }
